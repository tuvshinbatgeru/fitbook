...
},{"../../env.js":1}],48:[function(require,module,exports){
var Vue // late bind
...
var _VerifyView2 = _interopRequireDefault(_VerifyView);

var _IndexView = require('./web/IndexView.vue');

var _IndexView2 = _interopRequireDefault(_IndexView);

var _SearchView = require('./web/SearchView.vue');

var _SearchView2 = _interopRequireDefault(_SearchView);

var _ProfileView = require('./web/ProfileView.vue');

var _ProfileView2 = _interopRequireDefault(_ProfileView);

var _ProfileEditView = require('./web/ProfileEditView.vue');

var _ProfileEditView2 = _interopRequireDefault(_ProfileEditView);

var _ClubEditView = require('./web/ClubEditView.vue');

var _ClubEditView2 = _interopRequireDefault(_ClubEditView);

var _Default = require('./widgets/header/Default.vue');
...
var app = new _vue2.default({
	...
	components: {
		...
		TrainingDefault: _TrainingDefault2.default, ProfileView: _ProfileView2.default, ProfileEditView: _ProfileEditView2.default
	}
});

},{"../../../env.js":1,"./components/CustomModal.vue":55,"./components/CustomToast.vue":56,"./settings/Tools.js":69,"./web/ClubEditView.vue":70,"./web/IndexView.vue":71,"./web/ProfileEditView.vue":72,"./web/ProfileView.vue":73,"./web/SearchView.vue":74,"./web/VerifyView.vue":75,"./widgets/content/TeacherDefault.vue":76,"./widgets/content/TrainingDefault.vue":77,"./widgets/header/Default.vue":78,"chart.js":2,"vue":51,"vue-env":47,"vue-resource":49}],54:[function(require,module,exports){
...
exports.default = {
	...
	computed: {
		...
		percentageColor: function percentageColor() {
			if (this.percentage > 50) return this.colors[0];
			if (this.percentage > 80) return this.colors[1];
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-03cd24e7", module.exports)
  } else {
    hotAPI.update("_v-03cd24e7", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":51,"vue-hot-reload-api":48,"vueify/lib/insert-css":52}],55:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
},{"../context/AddTraining.vue":60,"../context/FileManager.vue":61,"../context/teachers.vue":62,"vue":51,"vue-hot-reload-api":48,"vueify/lib/insert-css":52}],56:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
},{"vue":51,"vue-hot-reload-api":48,"vueify/lib/insert-css":52}],57:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n")
"use strict";
...
},{"vue":51,"vue-hot-reload-api":48,"vueify/lib/insert-css":52}],58:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3f3bb728", module.exports)
  } else {
    hotAPI.update("_v-3f3bb728", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":51,"vue-hot-reload-api":48,"vueify/lib/insert-css":52}],59:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
exports.default = {
	...
	ready: function ready() {
		this.instance = $('.tokenize').tokenize({ displayDropdownOnFocus: true });
		this.instance.onDropdownShow = function (e) {
			alert('show');
		};
	}
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\t<select id=\"tokenize\" multiple=\"multiple\" class=\"tokenize\" style=\"width:100px;     margin: 0px;\n    padding: 0px;\n    border: 0px;\n    display: none;\">\n\t    <option value=\"1\">Саун</option>\n\t    <option value=\"2\">Душ</option>\n\t    <option value=\"3\">Ёог</option>\n\t    <option value=\"4\">Шүүгээ</option>\n\t    <option value=\"5\">Eleanor</option>\n\t</select>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2d605127", module.exports)
  } else {
    hotAPI.update("_v-2d605127", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":51,"vue-hot-reload-api":48,"vueify/lib/insert-css":52}],60:[function(require,module,exports){
'use strict';
...
},{"vue":51,"vue-hot-reload-api":48}],61:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
var _CircleProgressBar = require('../components/CircleProgressBar.vue');
	...
	methods: {
		...
		getFiles: function getFiles() {
			...
			this.$http.get(this.$env.get('APP_URI') + 'api/user/files?selected=' + maps).then(function (response) {
				...
				_this.percentage = parseInt(_this.actualSize * 100 / _this.maxSize);
			}, function (response) {});
		},
		...
		toggle: function toggle(photo) {
			...
			if (!this.multiple) {
				if (this.before && this.before != photo) this.unselect();
				this.before = photo;
			}
		}
	},
...
},{"../components/CircleProgressBar.vue":54,"vue":51,"vue-hot-reload-api":48,"vue-waterfall":50,"vueify/lib/insert-css":52}],62:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
},{"vue":51,"vue-hot-reload-api":48,"vueify/lib/insert-css":52}],63:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n")
"use strict";
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-48e0c687", module.exports)
  } else {
...
exports.default = {
	...
	methods: {
		init: function init() {
			...
			this.$http.get(this.$env.get('APP_URI') + 'api/club/edit/' + this.clubid + '/member').then(function (response) {
...
exports.default = {
	...
	methods: {
		init: function init() {
			...
			this.$http.get(this.$env.get('APP_URI') + 'api/club/edit/' + this.clubid + '/request').then(function (response) {
		...
		acceptRequest: function acceptRequest($request) {
			...
			this.$http.put(this.$env.get('APP_URI') + 'api/club/edit/' + this.clubid + '/request/' + $request.id, { 'roleType': $request.pivot.type, 'requestType': 'Accepted' }).then(function (response) {
				_this2.$dispatch('accept-request', $request);
				_this2.requests.$remove($request);
			}, function (response) {});
		},
		...
		rejectRequest: function rejectRequest($request) {
			...
			this.$http.put(this.$env.get('APP_URI') + 'api/club/edit/' + this.clubid + '/request/' + $request.id, { 'roleType': $request.pivot.type, 'requestType': 'Rejected' }).then(function (response) {
				_this3.$dispatch('reject-request', $request);
				_this3.requests.$remove($request);
			}, function (response) {});
		},

		filterByRequestType: function filterByRequestType(obj) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-188ca5a1", module.exports)
  } else {
    hotAPI.update("_v-188ca5a1", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":51,"vue-hot-reload-api":48,"vueify/lib/insert-css":52}],67:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n")
'use strict';
...
},{"vue":51,"vue-hot-reload-api":48,"vueify/lib/insert-css":52}],68:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-0ac6d3b7", module.exports)
  } else {
    hotAPI.update("_v-0ac6d3b7", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../.././components/FtTraining.vue":57,"vue":51,"vue-hot-reload-api":48,"vueify/lib/insert-css":52}],69:[function(require,module,exports){
'use strict';
...
var _ClubDashboard = require('.././menus/manager/ClubDashboard.vue');

var _ClubDashboard2 = _interopRequireDefault(_ClubDashboard);

var _ClubMembers = require('.././menus/manager/ClubMembers.vue');

var _ClubMembers2 = _interopRequireDefault(_ClubMembers);

var _ClubRequests = require('.././menus/manager/ClubRequests.vue');

var _ClubRequests2 = _interopRequireDefault(_ClubRequests);

var _ClubTraining = require('.././menus/manager/ClubTraining.vue');
...
exports.default = {
	...
	methods: {
		init: function init() {
			...
			this.$http.get(this.$env.get('APP_URI') + 'api/club/edit/' + this.clubid + '/index').then(function (response) {
				_this.members_count = response.data.members_count;
				_this.requests_count = response.data.requests_count;
			}, function (response) {});
		},
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-149d772a", module.exports)
  } else {
...
exports.default = {
	...
	methods: {
		loginAsFacebook: function loginAsFacebook() {
			/*this.$http.get('http://127.0.0.1/login/facebook', { headers: { 'Access-Control-Allow-Origin': true }}).then((response) => 
   {
   	debugger;
...
exports.default = {
	...
	events: {
		'chooseAvatar': function chooseAvatar($response) {
	...
	methods: {
		...
		chooseAvatar: function chooseAvatar($response) {
			...
			if (photo.length > 0) {
				this.$http.post(this.$env.get('APP_URI') + 'api/user/avatar/' + photo[0].id).then(function (res) {
					_this.user.avatar_url = res.data.avatar;
				}).catch(function (err) {});
			}
...
var _SearchTooltip = require('.././components/SearchTooltip.vue');
...
exports.default = {
	...
	methods: {
		...
		geoLocationSuccess: function geoLocationSuccess(position) {
			this.currentPos = {
   ...
   uri += '&radius=' + this.circleTool.radius;*/
		...
		clearPrevSearchResult: function clearPrevSearchResult() {
		...
		pinResults: function pinResults(club, key, timeout) {
		...
		calculateZoom: function calculateZoom() {
		...
		createBoundsForMarkers: function createBoundsForMarkers() {
	...
	components: {
		SearchTooltip: _SearchTooltip2.default
	}
};
if (module.exports.__esModule) module.exports = module.exports.default
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-333b9032", module.exports)
  } else {
    hotAPI.update("_v-333b9032", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{".././components/SearchTooltip.vue":58,"vue":51,"vue-hot-reload-api":48}],75:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	methods: {
		checkUserAvailable: function checkUserAvailable() {
			if (this.show) {
				this.$http.get(this.$env.get('APP_URI') + 'api/check-user/' + $('#username').val()).then(function (response) {
					response.data.result == 'no' ? $('#username').css('border', '1px solid red') : $('#username').css('border', '');
				}, function (response) {});
			}
		}
	}
...
},{"vue":51,"vue-hot-reload-api":48,"vueify/lib/insert-css":52}],77:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n\n")
'use strict';
...
},{"vue":51,"vue-hot-reload-api":48,"vueify/lib/insert-css":52}],78:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n\n")
'use strict';
	...
	methods: {
		getClubHeaderContent: function getClubHeaderContent(clubId) {
			...
			this.$http.get(this.$env.get('APP_URI') + 'api/club/' + clubId + '/club-info').then(function (response) {
				...
				_this.request_status = response.data.request_status;
			}, function (response) {});
		},
